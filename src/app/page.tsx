          ...
          <div className="p-6">
            ...
            {hasAnswered && (
              <div className="mt-5">
                ...
                >
                  <span className="inline-flex items-center justify-center gap-2">
                    {currentIndex < QUESTION_COUNT - 1 ? "Question suivante" : "Terminer"} <ChevronRight size={20} />
                  </span>
                </button>
              </div>
            )}
